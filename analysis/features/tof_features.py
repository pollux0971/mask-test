...
# 所以「有意義的最小 σ」不可能小於 1/√12 ≈ 0.28868——底線設 1e-3 只擋得住
# 除以零，擋不住「小到沒有意義」：貼著剛性表面的 zone 量化後 σ≈0.026，
# 若守衛是 1e-3，z 會衝到 39（其他 zone 都在 ±3），而這個 zone 又會被 D11
# 的 SNR 排名成「活躍 zone」餵進 D01，全程沒有任何錯誤訊息（CONTRACTS §3.2.2）。
