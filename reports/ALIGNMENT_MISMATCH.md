...
🔴 **在錄樣板時，盡量把按鍵按住的時間控制得跟「講這個詞需要的時間」
一致，不要講完之後還按著不放，也不要提前按下等一下才開口。**
按鍵按住時間越接近實際講話時間，這個效應影響越小；按越久、講完後的
「靜止持續時間」占比越高，同一個詞在不同次錄音之間看起來就會越不一樣。
...
起訖點的即時 producer），這是一個已知、待補的缺口，不是這輪新發現的
bug，但這輪的量測讓它的急迫性變得清楚。
